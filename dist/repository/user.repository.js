    ...
    login(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                connection_1.default.query(sql, [email], (err, result) => __awaiter(this, void 0, void 0, function* () {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const insertResult = yield new Promise((resolve, reject) => {
                    connection_1.default.beginTransaction((transactionError) => __awaiter(this, void 0, void 0, function* () {
                        if (transactionError) {
                            reject(transactionError);
                            return;
                        }
                        try {
                            connection_1.default.query("INSERT INTO users SET ?", dbUser, (err, data) => __awaiter(this, void 0, void 0, function* () {
                                if (err) {
