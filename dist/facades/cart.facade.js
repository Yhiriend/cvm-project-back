...
class CartFacade {
    insertProductIntoCart(cartId, productId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield CartRepository.insertProductIntoCart(cartId, productId);
            }
            catch (error) {
                console.error(error);
    ...
    getCartElementsByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield CartRepository.getCartElementsByUserId(userId);
            }
            catch (error) {
                console.error(error);
    ...
    getCartByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield CartRepository.getCartByUserId(userId);
            }
            catch (error) {
                console.error(error);
    ...
    buyCart(cartId, totalToPay, paymentMethod, paymentType, userId, address, phone) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield CartRepository.buyCart(cartId, totalToPay, paymentMethod, paymentType, userId, address, phone);
            }
            catch (error) {
                console.error(error);
    ...
    removeProductFromCart(cartId, productId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield CartRepository.removeProductFromCart(cartId, productId);
            }
            catch (error) {
                console.error(error);
...
exports.default = new CartFacade();
