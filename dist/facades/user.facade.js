...
class UserFacade {
    signIn(user) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield UserRepository.signIn(user);
            }
            catch (error) {
                console.error(error);
    ...
    loginUser(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield UserRepository.login(email, password);
            }
            catch (error) {
                console.error(error);
    ...
    updateUser(user, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield UserRepository.update(user, newPassword);
            }
            catch (error) {
                console.error(error);
...
exports.default = new UserFacade();
